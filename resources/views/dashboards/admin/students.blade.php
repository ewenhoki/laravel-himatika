            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @else
                        <h4 class="card-title">Database Mahasiswa Semua Angkatan</h4>
                        @endif
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($st->user->avatar!=NULL)
                                                ...
                                                <a href="{{ asset('user_image/'.$st->user->avatar) }}" data-exthumbimage="{{ asset('user_image/'.$st->user->avatar) }}" data-src="{{ asset('user_image/'.$st->user->avatar) }}">
    ...
    $('#example').DataTable({
        ...
        buttons: [
            'copyHtml5',
            {
                ...
                title : function() {
                    return "Database Mahasiswa {{ (isset($gen)) ? $gen->year : 'Semua Angkatan'}}";
                },
                titleAttr : 'CSV'
            },
            {
